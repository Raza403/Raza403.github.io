...
const visaelem = document.getElementById("cc-visa");
const masterelem = document.getElementById("cc-master");
const discoverelem = document.getElementById("cc-discover");
const amexelem = document.getElementById("cc-amex");
const dinerselem = document.getElementById("cc-diners");
const jcbelem = document.getElementById("cc-jcb");
    ...
    suggested: function (element, suggestion) {
      if (!$hint.html()) {
        ...
        var suggestion = "Did you mean <span class='suggestion'>" +
          ...
          "@<a href='#' class='domain' style='font-weight:bold;text-decoration:underline;'>" + suggestion.domain +
          "</a></span>?";
...
function startValidation() {
  let elements = Array.from($("#form").find(".validate"));
...
const removePromo = document.getElementById("promoRemove")
...
// Adding acls course
function addACLS(){
  const aclsRecert = document.querySelector(".aclsRecert");
  const aclsRecertPrice = document.querySelector(".aclsRecert-price");
...
function calculateTotal(){
  ...
  const purePrices = getPrices.map(x =>{
  ...
  document.querySelector(".total-price").innerHTML = "$" + purePrices.reduce((a, b) => a + b, 0) + ".00";
}
...
function emailAnalytics() {
  ...
  const opts = document.getElementById('email-options').childNodes;
