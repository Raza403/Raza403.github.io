...
var imgSrc = ['./img/portfolio/ajax-typeAhead.png', './img/portfolio/CodePlayer.png', './img/portfolio/jsBSClock.png', './img/portfolio/CSSVariables.png', './img/portfolio/weather-app.png', './img/portfolio/JSdrumKit.png', './img/portfolio/konamiCode.png', './img/portfolio/holdShiftCheckboxes.png', './img/portfolio/randomQouteGenerator.png', './img/portfolio/flexJSImageGalerry.png', './img/portfolio/html5Canvas.png', './img/portfolio/Wikipedia-viewer.png', './img/portfolio/html5Video.png', './img/portfolio/twitchAPI.png', 'img/portfolio/gapi.png', './img/portfolio/reactionTimeGame.png', './img/portfolio/follow.png', './img/portfolio/AttributePage.png'];
var ModalimgSrc = ['./img/modalImgs/ajax-typeAhead.png', './img/modalImgs/CodePlayer.png', './img/modalImgs/jsBSClock.png', './img/modalImgs/CSSVariables.png', './img/modalImgs/weather-app.png', './img/modalImgs/JSdrumKit.png', './img/modalImgs/konamiCode.png', './img/modalImgs/holdShiftCheckboxes.png', './img/modalImgs/randomQouteGenerator.png', './img/modalImgs/flexJSImageGalerry.png', './img/modalImgs/html5Canvas.png', './img/modalImgs/Wikipedia-viewer.png', './img/modalImgs/html5Video.png', './img/modalImgs/twitchAPI.png', 'img/modalImgs/gapi.png', './img/modalImgs/reactionTimeGame.png', './img/modalImgs/follow.png', './img/modalImgs/AttributePage.png'];
var imgAlt = ['Image of type ahead project made by JS mainly', 'Image of live code player', 'Image of JavaScript and Bootstrap clock', 'Pic of CSS variable', 'Pic of local weather app', 'Image of JS drum kit', 'Pic of Konami code', 'Pic of hold shift checkBoxes', 'Pic of random quote generator', 'Image of JS flex image gallery', 'Pic of using HTML5 canvas', 'Pic of wikipedei viewer', 'Pic of custom HTML5 video player', 'Usage of twitch API', 'This image contains image of my website which uses…lopment, an example of full stack web development', 'Pic of reaction time game', 'Clone of follow along Navbar of stripe.com', 'Pic of attribute page to Abdul Sattar Edhi'];
var captionH4 = ['AJAX Type Ahead', 'Live Code Player', 'Bootstrap & JS Clock', 'JS & CSS Variables', 'Local Weather App', 'JavaScript & Bootstrap DrumKit', 'Konami Code using JavaScript', 'CheckBox selection by pressing shift key', 'Random Quote Generator and tweeting', 'JavaScript and Flex box image gallery', 'JavaScript & HTML5 Canvas', 'Search Wikipedia articles', 'Custom HTML5 Video player', 'Fetching Date from Twitch.tv API', 'Loation Based News Web', 'Reaction Time Game', 'Clone of follow along Navbar of stripe.com', 'FCC Attribute Page Project'];
// Adding Portfolio Item using JS
function addPortfolio() {
    var jsPortfolio = document.querySelector('.portfolio-add');
    ...
    var html = [];
    for (var i = 0; i < captionH4.length; i++) {
    ...
    var links = Array.from(document.querySelectorAll(".portfolio-link"));
